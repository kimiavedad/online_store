...
export class DisplayProductHandler implements IQueryHandler<DisplayProductQuery> {
    constructor(
    @InjectRepository(Product)
    private productRespository: Repository<Product>) {
    }

    async execute(query: DisplayProductQuery): Promise<any> {
        console.log('******************* asyn display product')
